...
let goodJokesModalButton =document.querySelector('.goodJokesModalButton')
...
function toggleButton(){
    ...
    // passing the joke to voice rss api
function tellMe(joke){
    VoiceRSS.speech({
        key: 'bea472add29e45ab884f0a518e8d3354',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
counterMinus.addEventListener('click',subtract)
counterPlus.addEventListener('click',addition)
goodJokesModalButton.addEventListener('click', openModal)
